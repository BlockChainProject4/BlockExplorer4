...
//     const consumedTxOuts = transactions.map((tx) => tx.txIns) // txIns로만 구성된 배열
//         .reduce((a, b) => a.concat(b), []) //txIns들을 하나의 배열로 붙히는 작업
//         .map((txIn) => new UnspentTxOut(txIn.txOutId, txIn.txOutIndex, '', 0));
    
//     // 2_2. 새로 들어온 트랙잭션 정보에서 추출한 UnspentTxOut생성
...
// const chceckSameElement = (txOuts, txOutIndex, txOutId) => {
...
export { getTransactionPool , addToTransactionPool, getCoinbaseTransaction, getUnspentTxOuts, updateTransactionPool }